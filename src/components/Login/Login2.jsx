              ...
              <div className="card" style={{ borderRadius: '1rem' }}>
                <div className="row g-0">
                  ...
                  <div className="col-md-6 col-lg-7 d-flex align-items-center" >
                    <div className="card-body p-4 p-lg-5 text-black" >
                      <form >
                        ...
                        <h5 className="fw-normal mb-3 pb-3" style={{ letterSpacing: 1 }}>Sign in to your account</h5>
                  ...
                  <div className="col-md-6 col-lg-5 d-none d-md-block " style={{ backgroundColor: "#00d084" }}  >
                    <img src="https://www.spif.in/wp-content/uploads/2021/09/mains.jpg" alt="login form" className="img-fluid" style={{ marginTop: "150px" }} />
                  </div>
